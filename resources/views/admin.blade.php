...
<body style="background-color: #a1ffd0;">
    <h1 style= "font-family: 'Franklin Gothic Medium'; background-color: #00fe7f; height: 100px; padding: 20px; display: flex; align-items: center; gap: 15px;">
        ...
        <div>Londo Bell E-Shop Admin Page</div>                               
    </h1>

    <div class="p-5">
    <a href="{{route('showCreate')}}" class='btn btn-primary' style="margin-bottom: 40px; margin-top: 100px;">
        + Create Item
    </a>
    ...
    {{ asset('storage/images/' . $item->image) }}
                    ...
                    <td>
                        <div class="d-flex gap-2">
                            <a href="{{route('showUpdate', $item->id)}}" class='btn btn-warning'>Update Item</a>
